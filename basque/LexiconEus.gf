...
lin like_V2 = mkV2 "gustatu" R.IzanDat ; -- | ukanV "atsegin" ;
...
lin speak_V2 = mkV2 "hitz" egin_V ; --Apertium
...
oper
  ...
  egin_V2 : V2 = mkV2 "egin" ;

  -- Some synthetic verbs
  etorri_V : R.Verb1 = R.syntVerbDa "etorri" R.Etorri ;

  ibili_V : R.Verb1 = R.syntVerbDa "ibili" R.Ibili ;

  jakin_V2 : R.Verb2 = R.syntVerbDu "jakin" R.Jakin ;

  joan_V : R.Verb1 = R.syntVerbDa "joan" R.Joan ;
}